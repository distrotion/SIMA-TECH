    ...
    if (true) {
      ...
      for (var i = 0; i < databuff.length; i++) {
        ...
        output.add(YMDDATAmodel(
          ...
          QTY: _NullCheck(databuff[i]['TimeGetIn']),
          LoadingTime01: _daycon(_NullCheck(databuff[i]['TimeGetOut'])),
          Degressing02Temp: todesimol(_NullCheck(databuff[i]['State02tempPV'])),
          Degressing02Time: _NullCheck(databuff[i]['State01timePV']),
